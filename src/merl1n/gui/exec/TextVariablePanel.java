 ...
 */ 
public class TextVariablePanel extends VariablePanel {
    /**
     * ComboBox
     */
     ...
     * Constructor
     */
    public TextVariablePanel(Variable variable) {
        super(variable);
    }
    ...
    protected JPanel createValuePanel() {
        ...
        if (variable.isEnumerative()) {
            ...
            for (int i=0; i < range.size(); i++) {
                String item = " "+(String) range.elementAt(i)+" ";
            ...
            text = new JTextField((String) variable.getValue(),40);
    ...
    public void assign() {
        if (variable.isEnumerative()) {
            ...
            variable.setValue(text.getText().trim());
        }
    }
}